...
story1 = Story.create!(title: "Blue Whales and Other Sea Giants", body: body, author_id: King.id, date: 2020-05-13 13:20:14 -0400)
story2 = Story.create!(title: "Russia & Canada: The Two Biggest Countries", body: body, author_id: Hanks.id, date: 2020-01-11 13:20:14 -0400)
story3 = Story.create!(title: "Goldilocks Almost Had It", body: body, author_id: Bear.id, date: 2020-07-01 13:20:14 -0400)
story4 = Story.create!(title: "6 Things, Besides Size, that Gandalf and Hagrid have in Common", body: body, author_id: Biggie.id, date: 2020-02-11 13:20:14 -0400)
story5 = Story.create!(title: "The Humongous Fungus", body: body, author_id: Andre.id, date: 2020-03-02 13:20:14 -0400 )
story6 = Story.create!(title: "Not Tupac, but ______", body: body, author_id: BFG.id, date: 2020-04-03 13:20:14 -0400)
story7 = Story.create!(title: "Elephants Get Elephantitus, Too", body: body, author_id: Shaq.id, date: 2020-05-04 13:20:14 -0400)
story8 = Story.create!(title: "Sequoias, Firs, and Redwoods Even", body: body, author_id: Vince.id, date: 2020-06-05 13:20:14 -0400)
story9 = Story.create!(title: "10 Things That Wouldn't Fit in a Microwave", body: body, author_id: Nicole.id, date: 2020-05-06 13:20:14 -0400)
story10 = Story.create!(title: "A Watermelon to an Ant: It's All About Perspective", body: body, author_id: Brienne.id, date: 2020-06-07 13:20:14 -0400)
story11 = Story.create!(title: "Dreamliner: Honestly, Dream Bigger", body: body, author_id: Andre.id, date: 2020-03-08 13:20:14 -0400)
story12 = Story.create!(title: "Cruiseships, too", body: body, author_id: Shrek.id, date: 2020-09-11 13:20:14 -0400)
story13 = Story.create!(title: "Larger, Better, Faster, Stronger", body: body, author_id: King.id, date: 2020-09-09 13:20:14 -0400)
story14 = Story.create!(title: "Medicare For All", body: body, author_id: Hanks.id, date: 2020-03-11 13:20:14 -0400)
story15 = Story.create!(title: "The History of the Empire State Building", body: body, author_id: Brad.id, date: 2020-02-10 13:20:14 -0400)
story16 = Story.create!(title: "Too Big To Fail", body: body, author_id: King.id, date: 2020-03-12 13:20:14 -0400)
story17 = Story.create!(title: "Growing, Growing, Gone", body: body, author_id: Bear.id, date: 2020-04-13 13:20:14 -0400)
story18 = Story.create!(title: "Super Size Me", body: body, author_id: Vince.id, date: 2020-04-14 13:20:14 -0400)
...
story21 = Story.create!(title: "My History with Dinosaurs", body: body, author_id: BFG.id, date: 2020-04-15 13:20:14 -0400)
...
response1 = Response.create!(body: responseA, user_id: Andre.id, story_id: story1.id, date: 2020-01-15 13:20:14 -0400)
response2 = Response.create!(body: responseA, user_id: Shaq.id, story_id: story2.id, date: 2020-02-16 13:20:14 -0400)
response3 = Response.create!(body: responseA, user_id: King.id, story_id: story3.id, date: Time.now)
response4 = Response.create!(body: responseA, user_id: Hanks.id, story_id: story4.id, date: 2020-01-17 13:20:14 -0400)
response5 = Response.create!(body: responseA, user_id: Brad.id, story_id: story5.id, date: Time.now)
response6 = Response.create!(body: responseA, user_id: Biggie.id, story_id: story6.id, date: 2020-05-18 13:20:14 -0400)
response7 = Response.create!(body: responseA, user_id: Bear.id, story_id: story7.id, date: Time.now)
response8 = Response.create!(body: responseA, user_id: Vince.id, story_id: story8.id, date: 2020-05-19 13:20:14 -0400)
response9 = Response.create!(body: responseA, user_id: Nicole.id, story_id: story9.id, date: Time.now)
response10 = Response.create!(body: responseA, user_id: Brienne.id, story_id: story10.id, date: 2020-04-20 13:20:14 -0400)
response11 = Response.create!(body: responseA, user_id: BFG.id, story_id: story11.id, date: Time.now)
response12 = Response.create!(body: responseA, user_id: Shrek.id, story_id: story12.id, date: 2020-04-21 13:20:14 -0400)

response13 = Response.create!(body: responseB, user_id: Andre.id, story_id: story13.id, date: Time.now)
response14 = Response.create!(body: responseB, user_id: Shaq.id, story_id: story14.id, date: 2020-03-22 13:20:14 -0400)
response15 = Response.create!(body: responseB, user_id: King.id, story_id: story15.id, date: 2020-03-23 13:20:14 -0400)
response16 = Response.create!(body: responseB, user_id: Hanks.id, story_id: story16.id, date: 2020-03-24 13:20:14 -0400)
response17 = Response.create!(body: responseB, user_id: Brad.id, story_id: story17.id, date: Time.now)
response18 = Response.create!(body: responseB, user_id: Biggie.id, story_id: story18.id, date: 2020-03-25 13:20:14 -0400)
response19 = Response.create!(body: responseB, user_id: Bear.id, story_id: story19.id, date: Time.now)
response20 = Response.create!(body: responseB, user_id: Vince.id, story_id: story20.id, date: 2020-03-26 13:20:14 -0400)
response21 = Response.create!(body: responseB, user_id: Nicole.id, story_id: story21.id, date: Time.now)
response22 = Response.create!(body: responseB, user_id: Brienne.id, story_id: story22.id, date: 2020-02-27 13:20:14 -0400)
response23 = Response.create!(body: responseB, user_id: BFG.id, story_id: story23.id, date: Time.now)
response24 = Response.create!(body: responseB, user_id: Shrek.id, story_id: story1.id, date: 2020-02-28 13:20:14 -0400)
...
response27 = Response.create!(body: responseC, user_id: King.id, story_id: story4.id, date: 2020-03-29 13:20:14 -0400)
response28 = Response.create!(body: responseC, user_id: Hanks.id, story_id: story5.id, date: 2020-01-30 13:20:14 -0400)
response29 = Response.create!(body: responseC, user_id: Brad.id, story_id: story6.id, date: 2020-11-30 13:20:14 -0400)
response30 = Response.create!(body: responseC, user_id: Biggie.id, story_id: story7.id, date: 2020-07-29 13:20:14 -0400)
response31 = Response.create!(body: responseC, user_id: Bear.id, story_id: story8.id, date: 2020-05-31 13:20:14 -0400)
response32 = Response.create!(body: responseC, user_id: Vince.id, story_id: story9.id, date: 2020-06-02 13:20:14 -0400)
...
response37 = Response.create!(body: responseD, user_id: King.id, story_id: story14.id, date: 2020-03-03 13:20:14 -0400)
response38 = Response.create!(body: responseD, user_id: Hanks.id, story_id: story15.id, date: 2020-02-14 13:20:14 -0400)
response39 = Response.create!(body: responseD, user_id: Brad.id, story_id: story16.id, date: 2020-08-04 13:20:14 -0400)
response40 = Response.create!(body: responseD, user_id: Biggie.id, story_id: story17.id, date: 2020-10-05 13:20:14 -0400)
response41 = Response.create!(body: responseD, user_id: Bear.id, story_id: story18.id, date: 2020-11-20 13:20:14 -0400)
response42 = Response.create!(body: responseD, user_id: Vince.id, story_id: story19.id, date: 2020-12-20 13:20:14 -0400)
